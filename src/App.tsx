...
const BookCard: Component<{ book: Book }> = (props) => {
	return (
		<div class="border p-4 shadow w-96">
				...
				<ol class="list-inside list-decimal">
					<li>
						<button
							type="button"
							onClick={copyText}
							class="hover:bg-blue-200 inline-flex border items-center justify-center rounded-md font-medium text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 "
						>
							Copy <MdiClipboard />
						</button>{" "}
						the following text
						<pre class="overflow-auto w-80 my-4">{text()}</pre>
					</li>
					<li>
